...
class NGOHelperCreateView(
    ...
    #             subject="[RO HELP] New message for {} ".format(need.title.replace("\n", ""))[:50],
    #             to=user.email,
    #         )
...
class NGORegisterRequestCreateView(InfoContextMixin, CreateView):
    ...
    def get_success_message(self, cleaned_data):
        ...
        #     utils.send_email(
        #         template="mail/new_ngo.html", context=cleaned_data, subject="[RO HELP]", to=user.email
        #     )
