...
def meta_tags(context):
    ...
    return {
        ...
        "type": "website",
        "title": _(context.get("title", "Fight the Covid-19 pandemic.")),
        "image": request.build_absolute_uri(image_path),
        "description": _(context.get("description", "Enter DoNation.in and donate exactly where it is needed! Transparent, easy, efficient!!")),
    }
